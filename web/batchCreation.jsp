...
<html>
    <head>
        <title>Atlas - Batch Creation</title>
            ...
            <div class="left-content">
                <div class="mother-grid-inner">
                    ...
                    <div class="inner-block">
                        ...
                        <h1 style="text-align: center; margin-top: -30pt;">Batch Creation</h1>
                        <div class="btn-effcts panel-widget" style="text-align: center; padding-bottom: 20pt; padding-top: 40pt;">    
                            <form action="AddNewBatch" method="post" name="BatchForm">
                                <div class="row mb40">
                                    ...
                                    <%
                                        ...
                                        String query = "select * from list_technology";
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="assign_faculty">
                                        </div>
                                    </div>
                                    ...
                                    <a href="javascript:document.BatchForm.submit();" class="hvr-underline-from-center" style="margin-top: 20pt; vertical-align: bottom;">Create Batch</a>
