...
<html>
    ...
    <body>	
        <div class="page-container">	
            ...
            <form method="post" action="updateNontechTechnology.jsp" class="StudForm">
                <div class="col-1">
                ...
                <div class="col-2">
                    <label>
                        ...
                        <select tabindex="1" name="hardware">
                        ...
                        <input type="hidden" name="hardware" value="<%=rs.getString(3)%>">
                        <% }
                        %>
                    </label>
                </div>
                ...
                <div class="col-2">
                    <label>
                        ...
                        <select name="networking" tabindex="1">
                        ...
                        <input type="hidden" name="networking" value="<%=rs.getString(4)%>">
                        <% }
                        %>
                    </label>
                </div>
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="win_10" value="<%=rs.getString(5)%>">
                        <% }
                        %>
                    </label>
                </div>
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="ccna" value="<%=rs.getString(7)%>">
                        <% }
                        %>
                    </label>
                </div>
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="linux_security" value="<%=rs.getString(8)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="win_security" value="<%=rs.getString(9)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="linux" value="<%=rs.getString(10)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="ccna_security" value="<%=rs.getString(11)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <select name="network_security" tabindex="1">
                        ...
                        <input type="hidden" name="network_security" value="<%=rs.getString(12)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <select name="wireless_security" tabindex="1">
                        ...
                        <input type="hidden" name="wireless_security" value="<%=rs.getString(13)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="php" value="<%=rs.getString(14)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="web_security" value="<%=rs.getString(15)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <input type="hidden" name="cloud" value="<%=rs.getString(16)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <select name="web_development" tabindex="1">
                        ...
                        <input type="hidden" name="web_development" value="<%=rs.getString(17)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        ...
                        <select name="digital_marketing" tabindex="1">
                        ...
                        <input type="hidden" name="digital_marketing" value="<%=rs.getString(18)%>">
                        <% }
                        %>
                        <%
                ...
                <div class="col-2">
                    <label>
                        <%
                                if (rs.getString(19).equals("Not_Completed")) {%>
                        ...
                        %>
                        <%
                                if (rs.getString(19).equals("Completed")) {%>
                        <input value="<%=rs.getString(19)%>" disabled>
                        <input type="hidden" name="iot" value="<%=rs.getString(19)%>">
                        <% }
                        %>
                        <%
